...
# Convert data to a dataframe we can use
columnnames <- c("y", colnames(efron2004$x))
efron2004 <- data.frame(cbind(efron2004$y, efron2004$x))
colnames(efron2004) <- columnnames
