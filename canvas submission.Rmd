...
# Performs a forward model selection procedure that follows multiple paths simultaneously starting from the intercept only model and iteratively adding predictors. Models that meet the AIC’s improvement requirement are retained. If no model satisfies the requirement, the child model with the highest AIC is kept.
```{r}
